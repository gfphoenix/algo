...
public class Color {
	...
	public Color setU8(int r, int g, int b, int a) {
		this.r = r/255f;
		this.g = g/255f;
		this.b = b/255f;
		this.a = a/255f;
	...
	public static float mix(Color out, Color c, Color d, float alpha) {
		final float a1 = 1-alpha;
		if (out==null) {
			out = Color.tmp;
		}
		out.r = c.r * a1 + d.r * alpha;
		out. g = c.g * a1 + d.g * alpha;
		out. b = c.b * a1 + d.b * alpha;
		out. a = c.a * a1 + d.a * alpha;
		return out.toFloatBits();
	}
