 ...
 * environment. In order to drawC something you first have to call {@link ImmediateModeRenderer10#begin(int)} with the primitive
...
public class ImmediateModeRenderer10 implements ImmediateModeRenderer {
	...
	/** Starts a new list of primitives. The primitiveType specifies which primitives to drawC. Can be any of GL10.GL_TRIANGLES,
