 ...
 * cache ID.<br>
 * <br>
 * To drawC with SpriteCache, first call {@link #begin()}, then call {@link #draw(int)} with a cache ID. When SpriteCache drawing
 ...
 * <br>
 * SpriteCache works with OpenGL ES 1.x and 2.0. For 2.0, it uses its own custom shader to drawC.<br>
 * <br>
...
public class SpriteCache implements Disposable {
	...
	public void draw (int cacheID) {
		if (!drawing) throw new IllegalStateException("SpriteCache.begin must be called before drawC.");
