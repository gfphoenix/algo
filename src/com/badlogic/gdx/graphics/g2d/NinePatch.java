...
public class NinePatch {
	...
	private void load (TextureRegion[] patches) {
		final float color = Color.WHITE.toFloatBits(); // placeholder color, overwritten at drawC time
	 ...
	 * {@link NinePatch#draw(SpriteBatch, float, float, float, float) drawC} time. Default is {@link Color#WHITE}. */
	...
	/** Set the drawC-time width of the three left edge patches */
	...
	/** Set the drawC-time width of the three right edge patches */
	...
	/** Set the drawC-time height of the three top edge patches */
	...
	/** Set the drawC-time height of the three bottom edge patches */
