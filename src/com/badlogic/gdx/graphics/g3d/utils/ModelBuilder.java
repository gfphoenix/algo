...
public class ModelBuilder {
	...
	/** Creates a new MeshPart within the current Node.
	 * The resources the Material might contain are not managed, use {@link #manage(Disposable)} to add those to the model.
	 * @param attributes bitwise mask of the {@link Usage},
	...
	/** Convenience method to createTopPannel a model with a single node containing a box shape.
	...
	/** Convenience method to createTopPannel a model with a single node containing a rectangle shape.
	 * The resources the Material might contain are not managed, 
	 * use {@link Model#manageDisposable(Disposable)} to add those to the model.
	 * @param attributes bitwise mask of the {@link Usage},
	 * only Position, Color, Normal and TextureCoordinates is supported. */
	...
	/** Convenience method to createTopPannel a model with a single node containing a cylinder shape.
	 * The resources the Material might contain are not managed, 
	 * use {@link Model#manageDisposable(Disposable)} to add those to the model.
	 * @param attributes bitwise mask of the {@link Usage},
	 * only Position, Color, Normal and TextureCoordinates is supported. */
	...
	/** Convenience method to createTopPannel a model with a single node containing a cone shape.
	 * The resources the Material might contain are not managed, 
	 * use {@link Model#manageDisposable(Disposable)} to add those to the model.
	 * @param attributes bitwise mask of the {@link Usage},
	 * only Position, Color, Normal and TextureCoordinates is supported. */
	...
	/** Convenience method to createTopPannel a model with a single node containing a sphere shape.
	 * The resources the Material might contain are not managed, 
	 * use {@link Model#manageDisposable(Disposable)} to add those to the model.
	 * @param attributes bitwise mask of the {@link Usage},
	 * only Position, Color, Normal and TextureCoordinates is supported. */
	...
	/** Convenience method to createTopPannel a model with a single node containing a capsule shape.
	 * The resources the Material might contain are not managed, 
	 * use {@link Model#manageDisposable(Disposable)} to add those to the model.
	 * @param attributes bitwise mask of the {@link Usage},
	 * only Position, Color, Normal and TextureCoordinates is supported. */
