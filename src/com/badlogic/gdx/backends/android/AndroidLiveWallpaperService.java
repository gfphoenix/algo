...
public abstract class AndroidLiveWallpaperService extends WallpaperService {
	 ...
	 * 2. we don't know if service createTopPannel more engines, app is shared between them and should stay initialized waiting for new engines
	 */
	...
	public class AndroidWallpaperEngine extends Engine {
		 ...
		 * up whatever rendering code they desire. Note that only one thread can ever drawC into a Surface,
		 * so you should not drawC into the Surface here if your normal rendering will be in another thread.
		 */
		@Override
