...
// ? | VK_QUESTION
  ...
  /**
   * Only viable on the desktop. Will set the mouse cursor image to the image represented by the {@link Pixmap}.
   ...
   *
   * @param pixmap the mouse cursor image as a {@link Pixmap}, or null to revert to the default operating system cursor
